...
namespace Demo.Data
{
    ...
    public class DemoDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Guid guidProductTest = Uuid7.NewUuid7();
            Guid guidDeviceTest = Uuid7.NewUuid7();
            Guid guidCodeTest = Uuid7.NewUuid7();
            ...
            modelBuilder.Entity<DeviceInfo>().HasData(
                new DeviceInfo
                {
                    ...
                    ProductInfoId = guidProductTest,
                    AppVersion = "1.0.0",
                    FcmToken = "epfud8FNdTdXujs_KeZGWr:APA91bFbfiAbpWUqz2E_-IA8svXccFwKywm6reTSNS9C79dQmnpZM-fpVEOBEE8rJHlScw3rZNuVlkGItVJWQpz7GPHxOyQ6EYS1JAeALZtnWyBvkahWkJY",
            ...
            modelBuilder.Entity<NotificationActionConfig>().HasData(
                ...
                {
                    NotificationActionConfigId = Uuid7.NewUuid7(),
                    ProductInfoId = guidProductTest,
            ...
            modelBuilder.Entity<NotificationMsgTemplate>().HasData(
              ...
              {
                  NotificationMsgTemplateId = Uuid7.NewUuid7(),
                  CodeInfoId = guidCodeTest,
                  Gw = "Starlink_AP_7C5F",
                  Sound = "default",
                  CreateAtUtc = DateTime.UtcNow,
            ...
            modelBuilder.Entity<NotificationLimitsConfig>().HasData(
                ...
                {
                    NotificationLimitsConfigId = Uuid7.NewUuid7(),
